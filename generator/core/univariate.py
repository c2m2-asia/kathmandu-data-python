...
class Univariate():
    ...
    def generate_singleselect(self):
        ...
        s_select_univariate = s_select_univariate[['variable', 'value', 'label__en', 'label__ne', 'variable_group', 'total', 'perc_of_total', 'asked_total', 'universe', 'variable_label']]
    ...
    def generate_multiselect(self):
        ...
        m_select_univariate = m_select_univariate[['variable', 'value', 'label__en', 'label__ne', 'variable_group', 'total', 'perc_of_total', 'asked_total', 'universe', 'variable_label']]
